...
_gfn = _.extend(_gfn, {
	...
	logPageView: function () {
		...
		if (window.AnalyticsWebInterface && window.AnalyticsWebInterface.setCurrentScreen) {
			window.AnalyticsWebInterface.setCurrentScreen(pageTitle);
		} else if (window.webkit && window.webkit.messageHandlers && window.webkit.messageHandlers.setCurrentScreen) {
			window.webkit.messageHandlers.setCurrentScreen.postMessage({name: pageTitle});
		} else if (window.gtag) {
