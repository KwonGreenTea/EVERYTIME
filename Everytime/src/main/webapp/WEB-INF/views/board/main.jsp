		...
		<div class="main">
			<div class="card">
				<div class="board">
					...
					<c:forEach var="postVO" items="${postList1 }" begin="0" end="3">
						<a class="list" href="/370449/v/348629493"><time
			...
			<div class="bookstore">
				<a class="item" href="https://bookstore.everytime.kr"><div
					...
					<h4>일반물리학 1</h4> <span class="price">18,000원</span></a><a class="item"
					...
					<h4>생명의 위대한 비밀</h4> <span class="price">10,000원</span></a><a
					...
					<h4>파이썬인공지능COS Pro 2급</h4> <span class="price">5,000원</span></a>
			</div>
		</div>
	</div>
